...
You can install Adrenaline through our free and open-source installer by clicking the button below, running it, and then unchecking "Include non-performance features". You will need Java installed on your system to run the installer.
