...
import InstallationInfo from "../../components/InstallationInfo.astro";
...
If you want to go more in-depth into configuration after installation, see [post-install](/adrenaline/post-install).
