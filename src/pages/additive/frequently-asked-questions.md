...
**If you are building a modpack with a large amount of content then I would heavily advise that you base it off [Adrenaline](https://github.com/skywardmc/adrenaline) instead. Doing so would give you much easier control over the QoL mods available and would prevent mod conflicts. It may also run better. It'll also be less confusing to update and keep in sync in the future, as Adrenaline gets far less internal changes than Additive does.**
