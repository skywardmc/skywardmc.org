...
title: "Post-install"
description: "Post install instructions for Hammer."
style: "hammer"
---
...
Entity tick scheduler that improves logic performance without affecting Vanilla functionality. Not included in Hammer by default as it may have some rough edges. [May be implemented in the future](https://github.com/skywardmc/adrenaline/issues/53).
...
- Used to be shipped out of the box with Hammer, but [after some reasoning](https://github.com/skywardmc/adrenaline/issues/66), we have gotten rid of it.
